...
DOUYIN_RISK_PATTERNS = [
    re.compile(r"(?:评论区|评论里|留言区|留言|私信|留下|留个|留一下|发我|发一下|打出|扣[一1])[^。！？!?；;\n]{0,28}(?:股票代码|基金代码|代码|持仓|个股|股票|票)[^。！？!?；;\n]{0,42}", re.I),
    re.compile(r"(?:股票代码|基金代码|代码|持仓|个股|股票|票)[^。！？!?；;\n]{0,28}(?:发我|告诉我|留给我|留下来|放评论区|打在评论区|评论区见)", re.I),
    re.compile(r"(?:我|老师|博主|这边)[^。！？!?；;\n]{0,16}(?:帮你|给你|替你|免费)[^。！？!?；;\n]{0,28}(?:诊断|查看|看看|估值|把关)", re.I),
    re.compile(r"(?:我|老师|博主|这边)[^。！？!?；;\n]{0,16}(?:帮你|给你|替你|免费)[^。！？!?；;\n]{0,28}(?:分析|解读|判断)[^。！？!?；;\n]{0,18}(?:股票|基金|代码|持仓|个股|票|仓位|买卖点)", re.I),
